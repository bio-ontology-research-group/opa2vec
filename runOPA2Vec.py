...
parser.add_argument("entities", nargs = '?', metavar = "enities file", type = str, 
...
commandSix="python runWord2Vec.py "+str(classes_file)+" "+str(window)+" "+str(embedding)+" "+str(mincoun)+" "+str(model)
